// =====================================================================
//  rom.v  --  ذاكرة البرنامج (Program ROM)
//
//  ملاحظة مهمة للتصنيع الفعلي:
//  لا نستخدم `initial` لتعبئة الذاكرة، لأن `initial` لا يُترجَم (non-synthesizable)
//  عند التصنيع على ASIC. نستخدم بدلًا منها جملة case، فتتحول إلى منطق ثابت.
//
//  صيغة التعليمة (8 بت):  [7:4] = رمز العملية  |  [3:0] = المعامل
//
//  البرنامج التجريبي: يحسب 5+4+3+2+1 = 15 ثم يُخرج النتيجة ويتوقف.
// =====================================================================
